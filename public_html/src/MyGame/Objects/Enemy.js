...
var AllEnemy = [{Id:0, msg:"", mHealth:"50", atk:10, def:0, numItem:0, dropItemId:0},
    {Id:0, msg:"", mHealth:"50", atk:10, def:0, numItem:0, dropItemId:0},
    {Id:0, msg:"", mHealth:"50", atk:10, def:0, numItem:0, dropItemId:0},
    {Id:0, msg:"", mHealth:"50", atk:10, def:0, numItem:0, dropItemId:0}]
...
Enemy.prototype.fight = function (game){
    ...
    if(game.mHealthValue <= 0){
        ...
        for(var i=0;i<this.numItem;i++){
            game.mBag.AddItem(this.dropItem);
        }
    }
    msg = "You win, you lose " + total + " HP, get item " + this.dropItem;
    return msg;    
}
